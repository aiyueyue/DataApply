...
function getImpRoadReportingData()
{
    $.ajax({
        async:false,
        cache:false,
        type: "post",
        dataType : "json",
        url: serverUrl + "getImpRoadReporting.action",
        error: function () {
...
function showPieChart(rs)
{
    ...
    var strXML="<chart caption='重点路段拥堵指数' showValues='0' showZeroPies='1' manageLabelOverflow='1' showBorder='0' bgAlpha='10' baseFont='宋体' baseFontSize='12' >";
...
function showTable(rs) {
    ...
    for (var i = 0; i < tableData.length; i++) {
        ...
        tableBody += "</tr>";
        $("#impSectionInfo").append(tableBody);
    }
}
/**
