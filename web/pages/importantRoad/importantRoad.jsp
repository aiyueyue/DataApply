...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/importantRoad/getImpRoadReporting.js"></script>
    <script src="${pageContext.request.contextPath}/js/importantRoad/getImpRoadImg.js"></script>
    ...
    function addSslk(){
        ...
        //实时路况调用以显示重要道路的路段
        getImpRoadImg(sslkLayer, lonlat.lon, lonlat.lat, map.getZoom(), map.div.scrollWidth, map.div.scrollHeight);
...
<body>
    ...
    <div id="tableAndPieChart" style="overflow-y: auto; float:right; background-color:#fff; width:23.2%; height:100%;">
            <div id="impSectionPie" class="ibox float-e-margins" style="height: 35%; margin-bottom: 5px">
                <!-- 此处用于显示饼图-->
            </div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table id="impSectionInfo" class="table table-hover">
                        <thead>
                        <tr>
                            <th width="34%">
                                <div class="sort">
